...
export default function TOC() {
  ...
  return (
    <Nav variant="pills" id="wd-toc">
      ...
      <Nav.Item> <Nav.Link href="https://github.com/DonnaDoughnut/kambaz-react-web-app" target="_blank" id="wd-github"> My GitHub 
      </Nav.Link></Nav.Item>
    </Nav>
    ...
    //   <li><Link to="https://github.com/DonnaDoughnut/kambaz-react-web-app">Github</Link></li>
    // </ul>
  );
}  